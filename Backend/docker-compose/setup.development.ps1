openssl req -x509 -newkey rsa:2048 -keyout ../nginx/private_key.pem -out ../nginx/certificate.pem -days 365 -subj "/CN=choice.ru minio.choice.ru/O=choice/C=US" -passout pass:Pass123
