sudo openssl req -x509 -newkey rsa:2048 -keyout /etc/ssl/choice/private_key.pem -out /etc/ssl/choice/certificate.pem -days 365 -subj "/CN=choice.ru minio.choice.ru/O=choice/C=US" -passout pass:Pass123
