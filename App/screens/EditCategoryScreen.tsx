...
import {ImageBoxObject, UploadedBlob} from '../components/ImageBox.tsx';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.controlsContainer}>
        ...
        <View style={{alignSelf: 'center'}}>
          <TouchableOpacity
            disabled={route.params.category.categoryId <= 7}>
            <Image
              style={[styles.editIcon, { opacity: route.params.category.categoryId > 7 ? 1 : 0.5 }]}
      ...
      <View style={{paddingHorizontal: 15}}>
        ...
        <BorderedTextInput
          value={route.params.category.title}
          onChanged={(s: string) => {}}
