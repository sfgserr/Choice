...
class AppTextStyles {
  static TextStyle get appNameTextStyle =>
      const TextStyle(
  ...
  static TextStyle get authHeaderTextStyle =>
      const TextStyle(
        color: Color(0xFF303030),
        fontSize: 24,
        fontFamily: 'Inter',
  ...
  static TextStyle get textBtnTextStyle =>
      const TextStyle(
  ...
  static TextStyle get bodyLargeTextStyle =>
      const TextStyle(
          fontSize: 20,
          fontFamily: 'Inter',
          fontWeight: FontWeight.w600,
  ...
  static TextStyle get bodyMediumTextStyle =>
      const TextStyle(
  ...
  static TextStyle get mainBtnTextStyle =>
      const TextStyle(
        color: Colors.white,
        fontSize: 17,
        fontFamily: 'Inter',
  ...
  static TextStyle get appBarSecondTextStyle =>
      const TextStyle(
        color: Color(0xFF303030),
        fontSize: 24,
        fontFamily: 'Inter',
